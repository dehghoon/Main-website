...
export default function ArticlePage(){
 ...
 return <main className="publicArticle">
  ...
  <article className="articleShell">
   ...
   <div className="articleMeta">{new Date(article.published_at||article.created_at).toLocaleDateString()}</div><h1>{article.title}</h1>{article.excerpt&&<p className="articleLead">{article.excerpt}</p>}
