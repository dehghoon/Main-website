...
type Article={title:string;excerpt:string|null;body:string;author_name:string|null;published_at:string|null;created_at:string;cover_image_url:string|null;video_url:string|null;cover_image_alt:string|null;cover_image_title:string|null;cover_image_caption:string|null;cover_image_meta:string|null;cover_image_position:string|null;cover_image_size:string|null;video_title:string|null;video_caption:string|null;video_thumbnail_url:string|null;video_meta:string|null;tags:string[];calculator_name:string|null;calculator_url:string|null;seo_title:string|null;seo_description:string|null};
...
export default function ArticlePage(){
 ...
 return <main className="publicArticle">
  ...
  <article className="articleShell">
   ...
   <div className="articleMeta">{article.author_name||"LinkoTech"} · {new Date(article.published_at||article.created_at).toLocaleDateString()}</div><h1>{article.title}</h1>{article.excerpt&&<p className="articleLead">{article.excerpt}</p>}
