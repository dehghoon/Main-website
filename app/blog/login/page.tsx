...
export default function EmployeeWorkspacePage() {
  ...
  return <main className="authShell"><section className="authCard">
    ...
    <span className="eyebrow">Employee Access</span><h1>Employee Workspace</h1><p>One employee identity for LinkoTech internal tools, Timesheet, and the company publishing workspace. Employee accounts receive full internal access.</p>
    ...
    <form className="authForm" onSubmit={submit}>
      ...
      <button type="submit">{mode === "login" ? "Log In" : "Create Employee Account"}</button>
    </form>
    {message && <div className="authStatus">{message}</div>}
    <p style={{marginTop:20}}><a href="https://timesheet.linkoteq.com/">Open Timesheet</a> · <a href="/blog">Back to Blog</a></p>
  </section></main>;
}
